            ...
            return (
              <li key={item.label}>
                <a
                  ...
                  href={item.href}
                  className={`flex items-center gap-2 px-3 py-1 border-2 text-md rounded-md transition-all duration-200 ${
                    isActive
            ...
            return (
              <li key={item.label} className="w-full">
                <a
                  onClick={() => handleNavClick(item.id)}
                  href={item.href}
                  className={`flex items-center gap-3 px-3 py-2 border-2 text-md rounded-md hover:border-sky-400 hover:text-sky-400 transition-all ${
