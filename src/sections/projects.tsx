    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project) => (
          ...
          >
            <div className="w-full min-w-0 aspect-video overflow-hidden border-b border-slate-200 dark:border-blue-800/60">
              <img
                src={project.image}
                ...
                width="1200"
                height="600"
                sizes="(max-width: 767px) calc(100vw - 2rem), (max-width: 1023px) calc(100vw - 3rem), 576px"
